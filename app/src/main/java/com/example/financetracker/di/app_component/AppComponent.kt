...
import com.example.financetracker.data.di.RoomModule
...
@Singleton
@Component(modules = [RepositoryModule::class, RetrofitClientModule::class, UtilsModule::class, RoomModule::class])
